...
from musetalk.utils.device import get_inference_dtype, resolve_device
...
parser.add_argument("--device", type=str, default="auto", choices=["auto", "cuda", "mps", "cpu"], help="Compute device to use")
parser.add_argument("--gpu_id", type=int, default=0, help="GPU ID to use when CUDA is selected")
...
# Set data type
weight_dtype = get_inference_dtype(device, args.use_float16)
